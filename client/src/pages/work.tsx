    ...
    <div className="min-h-screen bg-black pt-[72px] sm:pt-[90px] md:pt-[106px]">
      ...
      >
        {categories.map((cat) => (
          ...
          >
            <span
              className={`md:text-[20px] transition-colors duration-200 cursor-pointer text-[18px] sm:text-[21px] ${
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 px-4 sm:px-[35px] pt-0 pb-4 sm:pb-[35px]"
