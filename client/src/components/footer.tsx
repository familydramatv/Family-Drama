      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.linkedin.com/company/tool-of-north-america/" target="_blank" rel="noopener noreferrer" className="text-white/50 transition-opacity hover:opacity-70" aria-label="LinkedIn" data-testid="link-footer-linkedin">
                <SiLinkedin className="w-4 h-4" />
              </a>
              <a href="https://www.instagram.com/toolofna/" target="_blank" rel="noopener noreferrer" className="text-white/50 transition-opacity hover:opacity-70" aria-label="Instagram" data-testid="link-footer-instagram">
                <SiInstagram className="w-4 h-4" />
              </a>
              <a href="https://www.facebook.com/toolofna" target="_blank" rel="noopener noreferrer" className="text-white/50 transition-opacity hover:opacity-70" aria-label="Facebook" data-testid="link-footer-facebook">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 flex-wrap">
          <p className="text-white/30 text-xs" data-testid="text-copyright">
            &copy; {new Date().getFullYear()} Tool of North America. All rights reserved.
          </p>
          <div className="flex items-center gap-6 flex-wrap">
            <a href="https://www.linkedin.com/company/tool-of-north-america/jobs/" target="_blank" rel="noopener noreferrer" className="text-white/30 text-xs transition-opacity hover:opacity-70" data-testid="link-footer-careers">
              Careers
            </a>
          </div>
        </div>
